  ...
  return (
    ...
    >
      <div className="flex flex-col items-center space-y-2">
        ...
        <div 
          className={`flex items-center space-x-2 px-2 py-1 rounded-md ${statusConfig.backgroundColor} ${statusConfig.borderColor} border shadow-lg`}
          style={{
        ...
        <div 
          className={`w-6 h-6 ${statusConfig.backgroundColor} ${statusConfig.borderColor} border rounded-full flex items-center justify-center cursor-pointer pointer-events-auto shadow-lg`}
          style={{
            boxShadow: '0 2px 4px rgba(0, 0, 0, 0.2)'
          }}
        >
